  ...
  <div class="col">
    <div class="e-tabs mb-3 px-3">
      <ul class="nav nav-tabs">
        <li class="nav-item"><a class="nav-link " href="<?php echo base_url("LoginController")?>">Stat</a></li>
        <li class="nav-item"><a class="nav-link active " href="#">Type_Cause</a></li>
        ...
        <div class="e-panel card">
          <div class="card-body">
            <div class="card-title">
              <h6 class="mr-2"><span>Stats</span><small class="px-1">Gérez les statistiques</small></h6>
            </div>
            <div class="e-table">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                        ...
                        <?php for($i=0;$i<count($type_cause);$i++) { ?>

                      <td class="align-middle text-center">
                        <?php echo $type_cause[$i][$columns[0]] ;?>
                      </td>
                      <td class="text-nowrap align-middle">
                        <?php echo $type_cause[$i][$columns[1]] ;?>
                      </td>
                      
                      <td class="text-nowrap align-middle"><span>
                      <?php echo $type_cause[$i][$columns[2]] ;?>
                      </span></td>
                      ...
                      <td class="text-center align-middle">
                        <div class="btn-group align-top">
                            ...
                            <button class="btn btn-sm btn-outline-secondary badge" type="button">delete</button>
                        </div>
                      </td>
                    </tr>
                          <?php } ?>
